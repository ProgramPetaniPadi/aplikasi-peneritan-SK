...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Dosen.create|perubahan') }}" class="btn btn-sm btn-success shadow-sm">
            ...
            <div class="table-responsive">
                <table class="table table-dark" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            @if (Auth::guard('Dosen')->user()->nip==$item->nip)
                            <td>{{ $i++ }}</td>
                            ...
                            <from>
                                <td><button class="btn-warning ">PROSES</button></td>
                            </from>
                            @endif
                        </tr>
                        @empty
