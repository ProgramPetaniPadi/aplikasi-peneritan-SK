...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Unit.usulanmengajarstaff') }}" class="btn btn-sm btn-warning shadow-sm">
            <i class=" text-white-50"></i> Kembali
        </a>
        <a href="{{ route('Unit.print|suratpermohonan', $items->id) }}" class="btn btn-sm btn-warning shadow-sm"
            target="_blank">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-3">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('Unit.staffsurattugas', $items->id) }}" method="post" autocomplete="off">
                        @csrf
                        <div class="form-group">
                            <label for="nosurattugas">NOMOR SURAT</label>
                            <input type="text" class="form-control" name="nosurattugas"
                                placeholder="nomor surat tugas beban mengajar" required="required">
                        </div>
                        <div class="form-group">
