                            ...
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.showusulanmengajarkoord', $items->id) }}  ">Usulan
                                            Surat</a></button>
                                </div>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.showsuratkoord', $items->id) }}  ">Surat
                                            Permohonan</a></button>
                                </div>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.lembardisposisikoord', $items->id) }}  ">Lembar
                                            Disposisi</a></button>
                                </div>
                            </td>
                        </tr>
