                            ...
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('admin.showusulanmengajarstaffAK', $items->id) }}  ">Usulan
                                            Surat</a></button>
                                </div>
                            </td>
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('admin.showsuratstaffAK', $items->id) }}  ">Surat
                                            Permohonan</a></button>
                                </div>
                            </td>
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('admin.lembardisposisistaffAK', $items->id) }}  ">Lembar
                                            Disposisi</a></button>
                                </div>
                            </td>
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('admin.surattugasbebanmengajarstaffAK', $items->id) }}  ">Surat
                                            Tugas</a></button>
                                </div>
                            </td>
                        </tr>
