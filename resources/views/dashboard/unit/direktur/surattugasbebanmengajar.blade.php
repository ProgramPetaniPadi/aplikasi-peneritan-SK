...
?>
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('Unit.disposisidirektur', $items->id) }}" method="post" autocomplete="on">
                        @csrf
                        <div class="form-group">
                            <label for="ttddirektur">DISPISISI</label>
                            <select name="ttddirektur" id="ttddirektur" class="form-control">
                                <option value="0">
                                    DIPERBAIKI</option>
                                <option value="1">
                                    DISPOSISI</option>
