...
?>
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('admin.storesurattugas', $items->id) }}" method="get" autocomplete="on">
                        @csrf
                        <div class="form-group">
                            <label for="nomorsurattugas">NOMOR SURAT TUGAS</label>
                            <input type="text" class="form-control" name="nomorsurattugas"
                                placeholder="nomor surat tugas" required="required">
                        </div>
                        <div class="form-group">
                            <label for="nama_direktur">NAMA DIREKTUR</label>
                            <input type="text" class="form-control" name="nama_direktur" placeholder="nama direktur"
                                required="required">
                        </div>
                        <div class="form-group">
                            <label for="nip_direktur">NIP DIREKTUR</label>
                            <input type="text" class="form-control" name="nip_direktur" placeholder="nip direktur"
                                required="required">
                        </div>
                        <div class="form-group">
