...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Unit.skdirektur') }}" class="btn btn-sm btn-warning shadow-sm">
    ...
    <div class="row">
                ...
                <table width='90%' align="center">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <h6 style='margin-bottom:2px' align=center>BEBAN MENGAJAR DOSEN SEMESTER
                                {{$items->semester}}
                            </h6>
                ...
                <table width=100% align="center">
                    <tr>
                        ...
                        <td>
                            ...
                            DIREKTUR POLITEKNIK NEGERI SAMBASs<br>
                            @if($items->qr_direktur == "1")
        ...
        <div class="col-xl-2 col-lg-2">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('Unit.disposisiSKbebanmengajar', $items->id) }}" method="post"
                        autocomplete="off">
                        @csrf
                        <div class="form-group">
                            <label for="qr_direktur">DISPISISI</label>
                            <select name="qr_direktur" id="qr_direktur" class="form-control">
                                <option value="0">
                                    DIPERBAIKI</option>
                                <option value="1">
                                    DISPOSISI</option>
