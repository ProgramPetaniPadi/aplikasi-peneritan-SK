                            ...
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.showusulanmengajardirektur', $items->id) }}  ">Usulan
                                            Surat</a></button>
                                </div>
                            </td>
                            <td>
                                ...
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.showsuratdirektur', $items->id) }}  ">Surat
                                            Permohonan</a></button>
                                </div>
                            </td>
                            <td>
                                ...
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.lembardisposisi', $items->id) }}  ">Lembar
                                            Disposisi</a></button>
                                </div>
                            </td>
                            <td>
                                @if($items->nomorsurattugas != "1")
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.surattugasbebanmengajar', $items->id) }}  ">Surat
                                            Tugas</a></button>
                                </div>
                                @endif
                            </td>
