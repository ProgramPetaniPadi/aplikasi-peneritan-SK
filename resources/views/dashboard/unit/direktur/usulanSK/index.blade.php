                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.lampirandirektur', $item->id) }}  ">Lampiran</a></button>
                                </div>
                            </td>
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.suratbebanmengajardirektur', $item->id) }}  ">Surat
                            ...
                            <td>
                                ...
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('Unit.lembaraccusulansk', $item->id) }}  ">Lembar
                                            Disposisi</a></button>
                                </div>
                            </td>
                        </tr>
