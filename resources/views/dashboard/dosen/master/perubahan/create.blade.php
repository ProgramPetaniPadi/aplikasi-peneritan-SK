...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Dosen.perubahan') }}" class="btn btn-danger btn-primary shadow-sm">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="post" action="{{ route('Dosen.store|perubahan') }}" enctype="multipart/form-data">
                @csrf
                <div class=" form-group">
                    <label for="nip">nip</label>
                    <input type="text" class="form-control" name="nip" placeholder="nip"
                        value="{{ Auth::guard('Dosen')->user()->nip }}" readonly>
                    <label for="nama">NAMA</label>
                    <input type="text" class="form-control" name="nama" placeholder="nama"
                        value="{{ Auth::guard('Dosen')->user()->nama }}" readonly>
