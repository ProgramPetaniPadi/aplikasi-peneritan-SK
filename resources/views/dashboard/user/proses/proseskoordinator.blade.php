...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('user.updatekoordinator', $item->id) }}" method="post" enctype="multipart/form-data"
                id="editform">
                @csrf
                ...
                <div class="form-group">
                    <label for="koordinator">FILE DOCUMENT</label>
                    <input type="file" class="form-control" name="koordinator" id="koordinator">
                </div>
                <div class="form-group">
