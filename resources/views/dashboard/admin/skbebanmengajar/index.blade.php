...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.tambahsk') }}" class="btn btn-sm btn-success shadow-sm">
            <i class=" text-white-50"></i> TAMBAH SK BEBAN MENGAJAR
        </a>
    </div>
    <div class="row">
                            ...
                            <td>
                                <div class="form-group ">
                                    <button type="botton" class="btn btn-success "><a class=" text-white"
                                            href="{{ route('admin.detailsk', $items->id) }}  ">DETAIL
                                            SK</a></button>
                                </div>
                            </td>
                        </tr>
