...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Unit.skkapprodi') }}" class="btn btn-sm btn-warning shadow-sm">
            <i class=" text-white-50"></i> Kembali
        </a>
        <a href="{{ route('Unit.printsk', $items->id) }}" class="btn btn-sm btn-warning shadow-sm" target="_blank">
