...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('admin.update|tendik', $item->id) }}" method="get">
                ...
                <div class="form-group">
                    <label for="id_pekerjaan" class="col-sm-2 col-sm-2 control-label">JENIS PEKERJAAN</label>
                    <select name="id_pekerjaan" id="id_pekerjaan" class="form-control" required="required">
                        <option value="$item->id_pekerjaan">{{ $item->pekerjaantendiks->pekerjaan }}</option>
