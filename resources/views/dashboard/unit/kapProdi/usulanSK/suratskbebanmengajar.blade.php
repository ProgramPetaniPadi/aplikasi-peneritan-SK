...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Unit.usulansk') }}" class="btn btn-sm btn-warning shadow-sm">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('Unit.disposisisuratpermohonansk', $item->id) }}" method="post"
                        autocomplete="on">
                        @csrf
                        <div class="form-group">
                            <label for="qr_ketua_jurusan">DISPISISI</label>
                            <select name="qr_ketua_jurusan" id="qr_ketua_jurusan" class="form-control">
                                <option value="0">
                                    DIPERBAIKI</option>
                                <option value="1">
                                    DISPOSISI</option>
                        ...
                        <div class="form-group">
                            <label for="qr_ketua_prodi">DISPISISI</label>
                            <select name="qr_ketua_prodi" id="qr_ketua_prodi" class="form-control">
                                <option value="0">
                                    DIPERBAIKI</option>
                                <option value="1">
                                    DISPOSISI</option>
