...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('user.updatedata', $item->id) }}" method="post" enctype="multipart/form-data"
                id="editform">
                @csrf
                ...
                <div class="form-group">
                    <label for="buk_persuratan">FILE DOCUMENT</label>
                    <input type="file" class="form-control" name="buk_persuratan" id="buk_persuratan">
                </div>
                <div class="form-group">
