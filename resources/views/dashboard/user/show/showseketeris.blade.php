...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        ...
        <a <a href="{{ route('user.prosesseketarisdirektur', $item->id) }}"
            class="btn btn-danger btn-primary shadow-sm">
    ...
    <div class="card shadow">
        <div class="card-body">
            <table class="table table-dark">
                <tr>
                    <td><embed type="application/pdf" src="{{ asset('storage/'.$item->	seketaris_direktur) }}"
