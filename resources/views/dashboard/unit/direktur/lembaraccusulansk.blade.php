...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('Unit.usulanskdirektur') }}" class="btn btn-sm btn-warning shadow-sm">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <form action="{{ route('Unit.updatedisposisiusulansk', $items->id) }}" method="get">
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input checked type="checkbox" id="mohondapatmewakili" name="mohondapatmewakili"
                                    value="1">
                                @else
                            ...
                            <td colspan="2">
                                ...
                                <input checked type="checkbox" id="mohonsaranpertimbangan" name="mohonsaranpertimbangan"
                                    value="1">
                                @else
                                <input type="checkbox" id="mohonsaranpertimbangan" name="mohonsaranpertimbangan"
                                    value="1">
                                @endif
                        ...
                        <tr>
                            <td colspan="4" height='50px'><label> catatan : </label><br>
                                <textarea name="catatandirektur" rows="3"
                        ...
                        <div class="form-group">
                            <label for="qrdirektur">DISPOSISI</label>
                            <select name="qrdirektur" id="qrdirektur" class="form-control">
                                <option value="1">
                                    DISPOSISI</option>
                                <option value="0">
                                    DIPERBAIKI</option>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <input checked type="checkbox">
                            @else
                            <input type="checkbox" id="analisakepegawaianamd" name="analisakepegawaianamd" value="1">
                            @endif
