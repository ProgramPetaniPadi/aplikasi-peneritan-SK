...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('user.updatewadir', $item->id) }}" method="post" enctype="multipart/form-data"
                id="editform">
                @csrf
                ...
                <div class="form-group">
                    <label for="wadir2">FILE DOCUMENT</label>
                    <input type="file" class="form-control" name="wadir2" id="wadir2">
                </div>
                <div class="form-group">
