...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('user.updatepersuratanSK', $item->id) }}" method="post" enctype="multipart/form-data"
                id="editform">
                @csrf
                ...
                <div class="form-group">
                    <label for="buk_persuratan_sk">FILE DOCUMENT</label>
                    <input type="file" class="form-control" name="buk_persuratan_sk" id="buk_persuratan_sk">
                </div>
                <div class="form-group">
