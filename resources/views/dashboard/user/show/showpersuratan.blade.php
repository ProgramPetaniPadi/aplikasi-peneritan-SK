...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        ...
        <a href="{{ route('user.prosespersuratan', $item->id) }}" class="btn btn-danger btn-primary shadow-sm">
    ...
    <div class="card shadow">
        <div class="card-body">
            <table class="table table-dark">
                <tr>
                    <td><embed type="application/pdf" src="{{ asset('storage/'.$item->buk_persuratan) }}" width="100%"
                            height="650"></td>
                </tr>
            </table>
