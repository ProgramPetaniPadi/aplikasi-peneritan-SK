...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.create|Pendidikandosen') }}" class="btn btn-sm btn-success shadow-sm">
                ...
                <table class="table table-dark" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.edit|Pendidikandosen', $item->id) }}" class="btn btn-info">
                                    <i class="fa fa-pencil-alt"></i>
                                </a>
                                <form action="{{ route('admin.destroy|Pendidikandosen', $item->id) }}" method="get"
