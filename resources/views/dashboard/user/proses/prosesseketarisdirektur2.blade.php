...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('user.updateseketrisdirektur2', $item->id) }}" method="post"
                ...
                <div class="form-group">
                    <label for="seketaris_direktur2">FILE DOCUMENT</label>
                    <input type="file" class="form-control" name="seketaris_direktur2" id="seketaris_direktur2">
                </div>
                <div class="form-group">
